...
urlpatterns = [
    ...
    url('take_attendance/$',
        views.NotificationsViewSet.as_view({'post': 'takeAttendance'}), name='take_attendance'),
    url('attendance_records/$',
        views.NotificationsViewSet.as_view({'get': 'AttendanceRecords'}), name='attendance_records'),
]
